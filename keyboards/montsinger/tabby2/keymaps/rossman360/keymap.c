...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_60_ansi(
    ...
    BSGUI,   ALTDEL,  KC_LCTL,                   SPCMOD,                                   KC_RALT, KC_LEFT, KC_DOWN,  KC_RIGHT
  ),

  [_FN1] = LAYOUT_60_ansi(
    KC_GRV,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_VOLD, KC_VOLU, KC_MUTE,
    KC_F7, RGB_MOD, KC_UP,   _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
    KC_F8, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______, KC_HOME, KC_LEFT, KC_UP,   KC_RIGHT,KC_END,  _______,          KC_PGDN,
    KC_F9, BL_DOWN, BL_TOGG, _______, _______, _______, _______, _______, KC_DOWN, _______, _______,                   _______,
