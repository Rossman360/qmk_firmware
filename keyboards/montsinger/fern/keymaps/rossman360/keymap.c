...
[_BASE] = LAYOUT(
   ...
   KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,   SOFF,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_MINS,
...
[_FN1] = LAYOUT(
   ...
   _______, _______, _______, _______, _______, _______, QK_BOOT, _______, _______, KC_DOWN, _______, _______, _______,
