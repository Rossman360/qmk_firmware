...
[BASE] = LAYOUT(
   ...
   CMDBSP,  ALTDEL,  KC_TAB,  KC_MINS,          KC_ENT,  SPCMOD, KC_MINS,                   KC_LEFT, KC_DOWN, KC_RGHT
),
...
[NUM] = LAYOUT(
   KC_GRV,  _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_MINS, KC_PLUS,
