...
[_BASE] = LAYOUT_all(
    ...
    JUMPBACK, KC_A   , KC_S   , KC_D   , KC_F   , KC_G   , KC_Z   , KC_H   , KC_J   , KC_K   , KC_L   , KC_SCLN, KC_QUOT,
    KC_LSFT , KC_Z   , KC_X   , KC_C   , KC_V   , KC_B   , KC_X   , KC_N   , KC_M   , KC_COMM, KC_DOT , KC_SLSH, KC_MINS,
...
[_FN1] = LAYOUT_all(
    ...
    KC_CAPS, _______, _______, _______, _______, _______, KC_Y   , KC_HOME, KC_LEFT, KC_UP  , KC_RIGHT,KC_END , KC_NO  ,
    _______, _______, XPANDR , _______, _______, _______, KC_Y   , _______, PMERGE , KC_DOWN, _______, _______, _______,
...
[_FN2] = LAYOUT_all(
    ...
    _______, _______, _______, _______, _______, _______, KC_Y   , _______, _______, _______, _______, _______, _______,
    _______, _______, _______, _______, _______, _______, KC_Y   , _______, _______, _______, _______, _______, _______,
...
[_DEL] = LAYOUT_all(
    ...
    REMCAPS, _______, _______, _______, _______, _______, KC_Y   , _______, KC_LEFT, KC_UP  ,KC_RIGHT, _______, _______,
    _______, _______, _______, _______, _______, _______, KC_Y   , _______, _______, KC_DOWN, _______, _______, _______,
...
[_NUM] = LAYOUT_all(
    ...
    KC_CAPS, _______, _______, _______, _______, _______, KC_Z   ,    KC_MINS, KC_4   , KC_5   , KC_6   , KC_COLN, _______,
    _______, _______, _______, _______, _______, KC_LBRC, KC_X   , KC_RBRC, KC_1   , KC_2   , KC_3   , KC_BSLS, _______, 
