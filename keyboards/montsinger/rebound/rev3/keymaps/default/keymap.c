...
[_QWERTY] = LAYOUT_all(
   ...
   KC_2,    KC_A,    KC_S,    KC_D,    KC_F,    KC_G,   KC_A,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,
   KC_3,    KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,   KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_ENT ,
   KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_SPC, KC_C,    KC_SPC,  KC_9,    KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
