...
#define ENTMOD LT(_COLEMAK, KC_ENTER)
...
[_QWERTY] = LAYOUT_all(
   ...
   KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,   KC_PGDN, KC_N,    KC_M,    KC_COMM, ENTMOD,  KC_SLSH, KC_ENT ,
   ENTMOD,  KC_LCTL, KC_LALT, KC_LGUI, LOWER,   KC_SPC, KC_ENT,  KC_SPC,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
