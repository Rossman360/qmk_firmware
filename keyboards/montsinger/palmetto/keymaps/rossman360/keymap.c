...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_60_ansi(
    ...
    KC_BSPC, KC_DEL,  KC_LCTL,                   SPCMOD,                                   KC_RALT, KC_LEFT, KC_DOWN,  KC_RIGHT
  ),
  ...
  [_FN1] = LAYOUT_60_ansi(
    ...
    BL_BRTG, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______, KC_HOME, KC_LEFT, KC_UP,   KC_RIGHT,KC_END,  _______,          KC_PGDN,
    _______, BL_DOWN, BL_TOGG, _______, _______, _______, _______, _______, KC_DOWN, _______, _______,                   _______,
    KC_GRV,  _______, _______, KC_NO,                                                       _______, _______, _______, QK_BOOT
  )
};
