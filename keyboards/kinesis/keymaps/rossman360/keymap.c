...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_BASE] = LAYOUT_pretty(
    KC_GRAVE, DESK1,    DESK2,    DESK3,    KC_F4,    KC_F5,    KC_F6,    XPANDR,    PMERGE,         KC_F9,    KC_F10,   KC_F11,   KC_F12,   KC_PSCR,  KC_SLCK,  KC_PAUS,  KC_FN0,   RESET,
 ...
 [_FN1] = LAYOUT_pretty(
    ...
    _______,  _______,  _______,  _______,  _______,  _______,                                                                   _______,  PMERGE,   KC_DOWN,  _______,  _______,  _______,
              _______,  _______,  _______,  _______,                                                                                       _______,  _______,  _______,  _______,
                                                      _______,  _______,                                               _______,  _______,
                                                                _______,                                               _______,
                                            LWORD,    RWORD,    RWORD,                                                 _______,  _______, _______
  ),
  ...
  [_FN2] = LAYOUT_pretty(
    ...
    _______,  _______,  _______,  _______,  _______,  _______,                                                                   _______,  KC_4   ,  KC_5   ,  KC_6   ,  COLON  ,  _______,
  ...
  [_NUM] = LAYOUT_pretty(
    ...
    _______,  _______,  _______,  _______,  _______,  _______,                                                                   _______,  KC_1   ,  KC_2   ,  KC_3   ,  _______,  _______,
              _______,  _______,  _______,  _______,                                                                                       _______,  _______,  _______,  _______,
                                                      _______,  _______,                                               _______,  _______,
                                                                _______,                                               _______,
                                            _______,  _______, XXXXXXX,                                                 _______,  _______, KC_0
  ),
...
[_DEL] = LAYOUT_pretty(
    ...
    _______,  _______,  _______,  _______,  _______,  _______,                                                                   _______,  _______,  _______,  _______,  _______,  _______,
    _______,  _______,  _______,  _______,  _______,  _______,                                                                   _______,  _______,  _______,  _______,  _______,  _______,
    REMCAPS,  _______,  _______,  _______,  _______,  _______,                                                                   KC_HOME,  KC_LEFT,  KC_UP,    KC_RIGHT,  KC_END,   _______,
